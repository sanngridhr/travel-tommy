...
@router.post(PROJECTS_PATH, status_code=status.HTTP_201_CREATED)
...
@router.put(PROJECTS_PATH + "{id}")
@router.patch(PROJECTS_PATH + "{id}")
...
@router.delete(PROJECTS_PATH + "{id}", status_code=status.HTTP_204_NO_CONTENT)
